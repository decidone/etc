...
<%  try{
			...
			<%   for(int i=0; i<list.size(); i++){   
			       BookVO book2 = list.get(i);   %>
			        ...
			        <tr>
			        	...
			        	<td><a href="bookClick.do?job=search&bookName=<%=book2.getBookName()%>" class="choice"><%=book2.getBookName() %></a></td>
	...
	%>
	  ...
	  <h1>도서 검색</h1>${result} <br>
          <div class="ss"><form action="bookClick.do" class="book-search-form">
            <li>
                <label for="search" id="search3"></label>
                <input type="text" name="bookName" id="search3" required>
            </li></div>
            <input type="hidden" name="job" value="search" />
            <input type="submit" value="검색" id="submit3">
            <div class"sss"></div>
            <li>
                <div class="home1">도서는 1인당 3권까지 빌릴 수 있습니다.</div>
            </li>
      </form>
      </div>
      <div class="wrapper9">
	  <% BookVO book2 = (BookVO)request.getAttribute("book2");
   			if(book2 != null) { %>
   			<div class="field">
          <ul> <form name='myForm' action="bookBorrow.do" method='post'>
              <li>
            ...
            <input type="hidden" name="info" value="${book2.info}">
            <li>
                <div class="home1">대여기간은 대여일로부터 15일입니다.</div>
            </li><div class="butt">
            		<input type="submit" value="대여" id="fix"/>
            		</div>
