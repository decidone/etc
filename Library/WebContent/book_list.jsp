...
<script type="text/javascript">
  function mySubmit(index) {
    if (index == 1) {
      document.myForm.action='bookInsert.do';
    }
    if (index == 2) {
      document.myForm.action='bookDelete.do';
    }
    if (index == 3) {
        document.myForm.action='bookUpdate.do';
      }
			...
			<%   for(int i=0; i<list.size(); i++){   
			       BookVO book2 = list.get(i);   %>
			        ...
			        <tr>
			        	...
			        	<td><a href="bookClick.do?job=asd&bookName=<%=book2.getBookName()%>" class="choice"><%=book2.getBookName() %></a></td>
